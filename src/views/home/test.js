...
Runtime.Import([
	{
		url: RootFolder + '/src/recorder-core.js',
		check: function () {
			return !window.Recorder
		},
	},
	{
		url: RootFolder + '/src/engine/mp3.js',
		check: function () {
			return !Recorder.prototype.mp3
		},
	},
	{
		url: RootFolder + '/src/engine/mp3-engine.js',
		check: function () {
			return !Recorder.lamejs
		},
	},
	{
		url: RootFolder + '/src/engine/wav.js',
		check: function () {
			return !Recorder.prototype.wav
		},
	},
	{
		url: RootFolder + '/src/engine/pcm.js',
		check: function () {
			return !Recorder.prototype.pcm
		},
	},
])
